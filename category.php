...
<?php
  ...
  <button class="btn btn-outline-danger" type="submit" name="updateStatus">Log Out</button>
        ...
        <ul class="nav nav-tabs mb-2" id="ex1-tabs" role="tablist">
            ...
            <a style="text-decoration: none;"href="kpi.php">
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="ex1-tab-1" data-bs-toggle="pill" data-bs-target="#ex1-tabs-1" type="button"
                    role="tab" aria-controls="ex1-tabs-1" aria-selected="true">By Day</button>
            </li>
            ...
            <li class="nav-item" role="presentation">
                ...
                <button class="nav-link active" id="ex1-tab-3" data-bs-toggle="pill" data-bs-target="#ex1-tabs-3"
